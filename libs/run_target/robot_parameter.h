...
enum {
    ...
    DEFAULT_TRANSLATIONAL_VELOCITY = 300, // [mm/sec]
    DEFAULT_ROTATIONAL_VELOCITY = 16384,  // [direction/sec]
    DEFAULT_TRANSLATIONAL_ACCELERATION = 300, // [mm/sec^2]
    DEFAULT_ROTATIONAL_ACCELERATION = 16384,  // [direction/sec^2]
};
